...
let workExamplesAllTab = document.querySelector(".we__tabs-title-one");
let workExamplesGraphDesignTab = document.querySelector(".we__tabs-title-two");
let workExamplesWebDesignTab = document.querySelector(".we__tabs-title-three");
let workExamplesLandingTab = document.querySelector(".we__tabs-title-four");
let workExamplesWordpressTab = document.querySelector(".we__tabs-title-five");
...
function selectWorkExamplesTab() {
  workExamplesTabTitle.forEach((item) =>
    item.classList.remove("work-examples__tabs-aktive")
  );
  this.classList.add("work-examples__tabs-aktive");
}
